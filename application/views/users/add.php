...
<div class="row">
    <div class="col-md-12">
        <div class="jumbotron">
            ...
            <p>Add a new user with general information, addresses, timezone, language to personalized your experience
                with
                our platform</p>
        </div>
    </div>
        ...
        <form action="users/create" method="post" id="signup_signupForm">
            <div class="form-group <?php echo(isset($error['first_name']) ? 'has-error' : ''); ?>">
                ...
                <input required="required" type="text" name="user[first_name]" class="form-control"
                       value="<?php echo(isset($oldValue['first_name']) ? $oldValue['first_name'] : '');
                       $this->session->unset_userdata('oldValue'); ?>" id="exampleInputFirstName"
            ...
            <div class="form-group <?php echo(isset($error['last_name']) ? 'has-error' : ''); ?>">
                ...
                <input required="required" type="text" name="user[last_name]" class="form-control"
                       value="<?php echo(isset($oldValue['last_name']) ? $oldValue['last_name'] : '');
                       $this->session->unset_userdata('oldValue'); ?>" id="exampleInputLastName"
            ...
            <div class="form-group <?php echo(isset($error['email_address']) ? 'has-error' : ''); ?>">
                ...
                <input required="required" type="text" name="user[email_address]" class="form-control"
                       value="<?php echo(isset($oldValue['email_address']) ? $oldValue['email_address'] : '');
                       $this->session->unset_userdata('oldValue'); ?>" placeholder="example@gmail.com">
                <?php
            ...
            <button type="submit" class="btn btn-success" id="signup_btnCreate">Create User</button>
            <br>
        </form>
    </div>
</div>